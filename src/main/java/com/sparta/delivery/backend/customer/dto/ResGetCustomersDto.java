...
@Getter
@Builder
@Schema(name = "ResGetCustomersDto", description = "고객 목록 조회 응답 (관리자용)")
public class ResGetCustomersDto {
	...
	public static ResGetCustomersDto from(Customer customer) {
		return ResGetCustomersDto.builder()
